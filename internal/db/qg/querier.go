...
type Querier interface {
	...
	GetGameInStageLock(ctx context.Context, arg GetGameInStageLockParams) (Game, error)
	...
	GetGameStateLock(ctx context.Context, id int64) (GetGameStateLockRow, error)
	...
	TestCreateGameStatus(ctx context.Context, gameID int64, stage GameStage) (GameStatus, error)
